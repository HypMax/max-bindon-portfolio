...
- **Technology:** Tableau.
- **Results:** [Slides presented to the client](https://www.canva.com/design/DAFrmMtLDdE/IriuagEhR2quz51eFkMagw/edit?utm_content=DAFrmMtLDdE&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton) detail a number of findings and recommendations. The recommendations included prioritizing larger project clients for stability, balancing work around key project types to best optimize skills, assessing utilization distribution by role for targeted team development, aligning hiring targets with utilization goals for sustainable growth, standardizing data input for reliability, and integrating data sources for greater quality of insights.
